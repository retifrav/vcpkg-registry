...
function(boost_configure_and_install)
    ...
    # beta builds contains some text in the version string
...
include(BoostRoot)\n"
    ...
    if(PORT MATCHES "boost-(mpi|graph-parallel|property-map-parallel)")
        list(APPEND arg_OPTIONS -DBOOST_ENABLE_MPI=1)
    endif()

    if(PORT MATCHES "boost-(python|parameter-python)")
        list(APPEND arg_OPTIONS -DBOOST_ENABLE_PYTHON=1)
    endif()
    ...
    list(REMOVE_ITEM cmake_paths
        "${cmake_files}"
        "${CURRENT_PACKAGES_DIR}/lib/cmake/boost_${boost_lib_name_config}-${SEMVER_VERSION}"
    )
    foreach(config_path IN LISTS cmake_paths)
        ...
        vcpkg_cmake_config_fixup(
            ...
            CONFIG_PATH lib/cmake/${config_name}-${SEMVER_VERSION}
    ...
    if(PORT MATCHES "boost-(stacktrace|test)")
        ...
        vcpkg_cmake_config_fixup(
            PACKAGE_NAME boost_${boost_lib_name_config}
            CONFIG_PATH lib/cmake/boost_${boost_lib_name_config}-${SEMVER_VERSION}
        )
    endif()
    ...
    configure_file(
        "${CURRENT_HOST_INSTALLED_DIR}/share/vcpkg-boost/usage.in"
        "${CURRENT_INSTALLED_DIR}/share/${PORT}/usage"
    )
endfunction()
