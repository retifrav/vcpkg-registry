if(VCPKG_TARGET_IS_LINUX)
    message(
        NOTICE
            "OpenSSL requires GNU/Linux kernel headers pre-installed with the system package manager. "
            "For instance, on Debian/Ubuntu distributions those can be installed with `apt install linux-libc-dev`, "
            "on Arch distributions with `pacman -S linux-api-headers`, "
            "and on Alpine distributions with `apk add linux-headers`"
    )
endif()
...
if(CMAKE_HOST_WIN32)
    ...
    if(NOT MAKE)
        message(FATAL_ERROR "Could not find make, install it through your package manager")
    endif()
