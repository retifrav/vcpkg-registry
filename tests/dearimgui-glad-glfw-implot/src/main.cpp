...
bool show_demo_window_dearimgui = false,
     show_demo_window_implot = false,
     show_another_window = false,
     show_implot_window = false;
...
bool initializeGLFW()
{
    ...
    std::cout << "[DEBUG] Monitor scale: " << xscale << "x" << yscale << std::endl;
    ...
    std::cout << "[DEBUG] OpenGL from GLFW "
...
bool initializeGLAD()
{
    ...
    {
        std::cout << "[DEBUG] GLAD initialized" << std::endl;
    }

    std::cout << "[DEBUG] OpenGL renderer: " << glGetString(GL_RENDERER) << std::endl;
...
void composeDearImGuiFrame()
{
    ...
    // a window is defined by Begin/End pair
    {
        ...
        ImGui::TextWrapped("%s", glfwGetVersionString());
        ...
        ImGui::Dummy(ImVec2(0.0f, 3.0f));
        ImGui::TextColored(ImVec4(1.0f, 0.0f, 1.0f, 1.0f), "ImPlot");
        ImGui::Text("%s", IMPLOT_VERSION);
        ...
        if (ImGui::BeginPopupModal("Easter egg", NULL))
        {
            ...
            {
                std::cout << "easter egg window | close button clicked" << std::endl;
        ...
        ImGui::Checkbox("showing a custom window", &show_another_window);
        if (show_another_window)
        {
            ...
            {
                std::cout << "custom window | close button clicked" << std::endl;
                show_another_window = false;
            }
        ...
        else
        {
            ...
            {
                show_demo_window_dearimgui = true;
            }
        }
